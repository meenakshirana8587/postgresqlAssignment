...
namespace DepartmentalStoreApp.Data.Migrations
{
    ...
    [Migration("20210521053804_configurePurchaseOrder")]
    partial class configurePurchaseOrder
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DepartmentalStoreApp.Domain.PurchaseOrder", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("DepartmentalStoreApp.Domain.Inventory", b =>
                {
                    ...
                    b.HasOne("DepartmentalStoreApp.Domain.Supplier", "Supplier")
                        .WithOne("Inventory")
                        .HasForeignKey("DepartmentalStoreApp.Domain.Inventory", "SupplierId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DepartmentalStoreApp.Domain.Product", b =>
                {
                    b.HasOne("DepartmentalStoreApp.Domain.PurchaseOrder", "PurchaseOrder")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("DepartmentalStoreApp.Domain.PurchaseOrder", b =>
                {
                    b.HasOne("DepartmentalStoreApp.Domain.Supplier", "Supplier")
                        ...
                        .HasForeignKey("DepartmentalStoreApp.Domain.PurchaseOrder", "SupplierId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
